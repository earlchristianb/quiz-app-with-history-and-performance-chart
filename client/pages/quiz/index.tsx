...
export const QuizScreen: NextPage = () => {
  ...
  const handleIncremenScore=(answer: string) => {
  ...
  const handleChooseAnswer = (e: React.FormEvent<HTMLButtonElement>) => {
    ...
    const numberDetails: quizItemsType = {
    ...
    setNewQuizResultState({
      ...newQuizResultsState,
      items: [...newQuizResultsState.items, numberDetails],
    });
  ...
  return (
    quizItems ? 
      ...
      <main className='space-y-2 md:space-y-8  flex flex-col justify-center items-center p-2 m-auto relative'> 
        ...
        font-medium p-2 rounded-md`} type="button" onClick={handleNextorSubmit}>{counter < 9 ? "Next" : "Submit"}</button>
       </main>
