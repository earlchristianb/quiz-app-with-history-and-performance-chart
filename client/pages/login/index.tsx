...
import {
	...
	userLogin,
	userSignUp,
} from "../../components/store/auth-slice";
	...
	return (
		<section className='h-screen w-full flex flex-col mx-auto  justify-center items-center z-0 m-auto'>
			...
			<div className='h-5/6 w-5/6 md:max-w-md flex justify-center items-center z-10 bg-sky-300 shadow-2xl rounded-sm'>
				<form
					className='flex flex-col items center justify-center space-y-5 p-3 w-4/6'
					...
					<input
						...
						className='p-1 rounded-sm placeholder-neutral-500'
					...
					<button
						type='submit'
						className='bg-white p-2 w-4/6 h-auto self-center rounded-md  text-center font-semibold'>
						{isSignup === true ? "Sign up" : "Log in"}
					</button>
